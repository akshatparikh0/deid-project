...
class SsnAndCreditCardTests(SimpleTestCase):
    ...
    def test_visa_and_mastercard_detected_as_other(self):
        self.assertIn(("4929-3813-3266-4295", "payment_card", "pattern"), _categories("4929-3813-3266-4295"))
        self.assertIn(("5370-4638-8881-3020", "payment_card", "pattern"), _categories("5370-4638-8881-3020"))
    ...
    def test_amex_and_diners_no_separator_detected(self):
        ...
        self.assertIn(("345389698201044", "payment_card", "pattern"), _categories("345389698201044"))
        self.assertIn(("30204861594838", "payment_card", "pattern"), _categories("30204861594838"))

    def test_luhn_invalid_number_rejected(self):
        # Same shape as a Visa card but fails the Luhn checksum.
        bad = "4929-3813-3266-4291"
        self.assertNotIn("payment_card", [cat for _, cat, _ in _categories(bad)])
...
class NameSplitTests(SimpleTestCase):
    ...
    def test_bare_name_with_no_context_is_generic(self):
        ...
        self.assertIn(("Robert Aragon", "person_name", "heuristic"), spans)
    ...
    def test_relation_cue_tags_generic_name(self):
        ...
        self.assertIn(("Margaret Ellery", "person_name"), cats)

    def test_comma_format_name(self):
        spans = _categories("SMITH, JOHN is a 45 y.o. male.")
        cats = [(v, c) for v, c, _ in spans]
        self.assertIn(("SMITH, JOHN", "person_name"), cats)
...
class LabelWordBoundaryTests(SimpleTestCase):
    ...
    def test_real_plan_id_still_detected(self):
        ...
        self.assertIn(("A1234567", "member_id", "pattern"), spans)
...
class FacilityTests(SimpleTestCase):
    def test_facility_label(self):
        ...
        self.assertIn(("Cedar Grove Medical Center", "facility_name", "pattern"), spans)
    ...
    def test_facility_suffix_without_label(self):
        ...
        self.assertIn("facility_name", cats)


class DateBoundaryTests(SimpleTestCase):
    def test_full_date_detected(self):
        self.assertIn(("03/14/2026", "other_date", "pattern"), _categories("Visit on 03/14/2026."))

    def test_month_year_detected(self):
        self.assertIn(("7/2023", "other_date", "pattern"), _categories("Surgery date: 7/2023"))
...
class ColumnHeaderContextTests(SimpleTestCase):
    def test_bare_name_in_name_column_detected(self):
        ...
        self.assertEqual(spans, [("Dorothy Whitcombe", "person_name", "context")])
    ...
    def test_month_year_in_date_column_detected(self):
        ...
        self.assertEqual([(v, c) for v, c, _ in spans], [("7/2023", "other_date")])
