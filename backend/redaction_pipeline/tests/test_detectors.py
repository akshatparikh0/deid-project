"""
Tests for the AI-assisted detectors (Azure AI Language, Claude) that
redaction_pipeline provides standalone — and that documents/ai_detection.py
reuses for exact-text parsing (parse_claude_items) and category-mapping
conventions in the Django app. Both API clients are mocked; nothing here
