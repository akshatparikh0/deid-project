"""
End-to-end tests for the standalone Pipeline (validate -> extract ->
detect -> policy -> true PDF redaction -> verify). This is the same engine
documents/finalize.py and documents/verify.py build on for the Django
app's reviewer-approved finalization — these tests exercise it directly,
with a real generated PDF and (in the second test) real Tesseract OCR.
"""
